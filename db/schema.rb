...
ActiveRecord::Schema.define(version: 2020_05_26_071642) do
  ...
  create_table "monthly_expenses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["expense_type_id"], name: "index_monthly_expenses_on_expense_type_id"
  end
  ...
  add_foreign_key "monthly_expenses", "expense_types"
